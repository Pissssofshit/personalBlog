	...
	<form action="/autophp/rem_account/" method="post">
		<ul class="list_A">
			<input type='hidden' name='_token' value='<?php echo e($csrf_token); ?>'><li><label class="display_name">账号名称</label><input type="text" maxlength="40" name="account_name" id="account_name" value="<?php echo e(isset($detail['account_name'])?$detail['account_name']:''); ?>"></input></li>
<li><label class="display_name">账号域名</label><input type="text" maxlength="255" name="account_url" id="account_url" value="<?php echo e(isset($detail['account_url'])?$detail['account_url']:''); ?>"></input></li>
<li><label class="display_name">公司id</label><input type="text" maxlength="10" name="company_id" id="company_id" value="<?php echo e(isset($detail['company_id'])?$detail['company_id']:''); ?>"></input></li>
