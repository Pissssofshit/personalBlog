		...
		<div id="main" class="easyui-panel" title="当前位置：rem >> 平台列表">
			<div class="easyui-panel" border="false" style="padding:1px">
				<fieldset>
	<legend>添加</legend>
	<form action="/autophp/rem_partner/" method="post">
		<ul class="list_A">
			<input type='hidden' name='_token' value='{{$csrf_token}}'><li><label class="display_name">平台名</label><input type="text" maxlength="40" name="partner_name" id="partner_name" value="{{isset($detail['partner_name'])?$detail['partner_name']:''}}"></input></li>
