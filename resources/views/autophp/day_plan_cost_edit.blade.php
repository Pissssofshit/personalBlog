		...
		<div id="main" class="easyui-panel" title="当前位置：data >> 成本提交表">
			<div class="easyui-panel" border="false" style="padding:1px">
				<fieldset>
	<legend>编辑</legend>
	<form action="/autophp/day_plan_cost/{{$detail->id}}" method="post">
		<ul class="list_A">
...
<li><label class="display_name">成本所属时间戳</label><input type="text"  maxlength="16" name="day_time" id="day_time" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="{{isset($detail['day_time'])?$detail['day_time']:''}}"></input></li>
