		...
		<div id="main" class="easyui-panel" title="当前位置：游戏管理 >> 游戏">
			<div class="easyui-panel" border="false" style="padding:1px">
				<fieldset>
	<legend>编辑</legend>
	<form action="/autophp/game_entity/{{$detail->id}}" method="post">
		<ul class="list_A">
...
<li><label class="display_name">游戏主体名称</label><input type="text" maxlength="250" name="name" id="name" value="{{isset($detail['name'])?$detail['name']:''}}"></input></li>
