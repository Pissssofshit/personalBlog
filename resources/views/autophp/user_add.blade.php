	...
	<form action="/autophp/user/" method="post">
		<ul class="list_A">
			<input type='hidden' name='_token' value='{{$csrf_token}}'><li><label class="display_name">用户名</label><input type="text" maxlength="250" name="username" id="username" value="{{isset($detail['username'])?$detail['username']:''}}"></input></li>
