		...
		<div id="main" class="easyui-panel" title="当前位置：rem >> 渠道列表">
			<div class="easyui-panel" border="false" style="padding:1px">
				<fieldset>
	<legend>添加</legend>
	<form action="/autophp/rem_channel/" method="post">
		<ul class="list_A">
			<input type='hidden' name='_token' value='{{$csrf_token}}'><li><label class="display_name">渠道名</label><input type="text" maxlength="40" name="channel_name" id="channel_name" value="{{isset($detail['channel_name'])?$detail['channel_name']:''}}"></input></li>
