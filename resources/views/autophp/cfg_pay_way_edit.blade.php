		...
		<div id="main" class="easyui-panel" title="当前位置：cfg >> 结算方式定义">
			<div class="easyui-panel" border="false" style="padding:1px">
				<fieldset>
	<legend>编辑</legend>
	<form action="/autophp/cfg_pay_way/{{$detail->id}}" method="post">
		<ul class="list_A">
			<input type="hidden" name="_method" value="PUT"/><input type='hidden' name='_token' value='{{$csrf_token}}' /><input type="hidden" maxlength="4" name="id" id="id" value="{{isset($detail['id'])?$detail['id']:''}}"></input>
