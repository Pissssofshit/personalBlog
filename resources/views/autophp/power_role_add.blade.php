		...
		<div id="main" class="easyui-panel" title="当前位置：权限管理 >> 角色管理">
			<div class="easyui-panel" border="false" style="padding:1px">
				<fieldset>
	<legend>添加</legend>
	<form action="/autophp/power_role/" method="post">
		<ul class="list_A">
			<input type='hidden' name='_token' value='{{$csrf_token}}'><li><label class="display_name">角色名称</label><input type="text" maxlength="30" name="power_role_name" id="power_role_name" value="{{isset($detail['power_role_name'])?$detail['power_role_name']:''}}"></input></li>
