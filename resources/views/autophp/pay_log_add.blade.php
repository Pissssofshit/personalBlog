		...
		<div id="main" class="easyui-panel" title="当前位置：data >> 充值订单表">
			<div class="easyui-panel" border="false" style="padding:1px">
				<fieldset>
	<legend>添加</legend>
	<form action="/autophp/pay_log/" method="post">
		<ul class="list_A">
			<input type='hidden' name='_token' value='{{$csrf_token}}'><li><label class="display_name">订单号</label><input type="text" maxlength="32" name="order_id" id="order_id" value="{{isset($detail['order_id'])?$detail['order_id']:''}}"></input></li>
