		...
		<div id="main" class="easyui-panel" title="当前位置：用户管理 >> 用户">
			<div class="easyui-panel" border="false" style="padding:1px">
				<fieldset>
	<legend>编辑</legend>
	<form action="/autophp/user/{{$detail->id}}" method="post">
		<ul class="list_A">
...
<li><label class="display_name">邮箱</label><input type="text" maxlength="250" name="email" id="email" value="{{isset($detail['email'])?$detail['email']:''}}"></input></li>
<li><label class="display_name">加密密码</label><input type="text" maxlength="250" name="password" id="password" value="{{isset($detail['password'])?$detail['password']:''}}"></input></li>
...
<li><label class="display_name">手机绑定时间戳</label><input type="text"  maxlength="16" name="mobile_bind_time" id="mobile_bind_time" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="{{isset($detail['mobile_bind_time'])?$detail['mobile_bind_time']:''}}"></input></li>
<li><label class="display_name">邮箱绑定时间戳</label><input type="text"  maxlength="16" name="email_bind_time" id="email_bind_time" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="{{isset($detail['email_bind_time'])?$detail['email_bind_time']:''}}"></input></li>
<li><label class="display_name"><a href='javascript:' title='1自然量2公会' >来源1</a>:</label><input type="text" maxlength="2" name="source" id="source" value="{{isset($detail['source'])?$detail['source']:''}}"></input></li>
<li><label class="display_name"><a href='javascript:' title='渠道标识' >来源2</a>:</label><input type="text" maxlength="11" name="ucode" id="ucode" value="{{isset($detail['ucode'])?$detail['ucode']:''}}"></input></li>
<li><label class="display_name"><a href='javascript:' title='子渠道扩展标示' >来源3</a>:</label><input type="text" maxlength="250" name="subucode" id="subucode" value="{{isset($detail['subucode'])?$detail['subucode']:''}}"></input></li>
<li><label class="display_name">注册ip</label><input type="text" maxlength="250" name="ip" id="ip" value="{{isset($detail['ip'])?$detail['ip']:''}}"></input></li>
...
<li><label class="display_name">昵称</label><input type="text" maxlength="250" name="nickname" id="nickname" value="{{isset($detail['nickname'])?$detail['nickname']:''}}"></input></li>
<li><label class="display_name"><a href='javascript:' title='1男2女' >性别</a>:</label><input type="text" maxlength="2" name="sex" id="sex" value="{{isset($detail['sex'])?$detail['sex']:''}}"></input></li>
<li><label class="display_name">头像</label><input type="text" maxlength="250" name="head_icon" id="head_icon" value="{{isset($detail['head_icon'])?$detail['head_icon']:''}}"></input></li>
<li><label class="display_name"></label><input type="text" maxlength="18" name="idcard" id="idcard" value="{{isset($detail['idcard'])?$detail['idcard']:''}}"></input></li>
<li><label class="display_name"></label><input type="text" maxlength="250" name="realname" id="realname" value="{{isset($detail['realname'])?$detail['realname']:''}}"></input></li>
<li><label class="display_name">盐值</label><input type="text" maxlength="20" name="salt" id="salt" value="{{isset($detail['salt'])?$detail['salt']:''}}"></input></li>
