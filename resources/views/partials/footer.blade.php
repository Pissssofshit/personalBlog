    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 l4 offset-l2">
                ...
                <ul>
                    <li><a href="{{ url('pages.show', 'links') }}" class="grey-text text-lighten-4">@lang('menus.links')</a></li>
                    <li><a href="{{ url('pages.show', 'about') }}" class="grey-text text-lighten-4">@lang('menus.about')</a></li>
    ...
    <div class="footer-copyright">
        <div class="container">
            © 2018 <a class="grey-text text-lighten-4" href="https://immiles.com">Miles</a>. <span class="hide-on-small-and-down">All rights reserved.</span> <a
                        href="{{ url('feeds.main') }}" class="white-text"><i class="material-icons feed">rss_feed</i></a>
            <span class="right">
                <a class="grey-text text-lighten-4 lang-dropdown-trigger locale" href="#" data-target='lang-dropdown'><i class="material-icons"><language></language></a> | <a class="grey-text text-lighten-4" href="https://opensource.org/licenses/MIT">MIT License</a>
            </span>
        </div>
    </div>
