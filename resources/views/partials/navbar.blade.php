...
<link rel="stylesheet" href="{{ URL::asset('sass/navbar.scss') }}">
{{-- NavBar --}}
    ...
    <nav id="nav-bar" class="z-depth-0">
        <div class="nav-wrapper container" id="nav-main-bar">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a class="waves-effect waves-light" href="{{ url('ttt') }}">@lang('menus.about')</a></li>
            </ul>
...
<ul id="cate-dropdown" class="dropdown-content">
    @foreach($categories as $category)
        <li><a class="waves-effect waves-teal" href="{{ url('categories.show', $category->slug) }}">{{ $category->name }}</a></li>
    @endforeach
</ul>
